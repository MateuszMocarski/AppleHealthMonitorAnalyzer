...
def test_http_drive_client_gets_file_metadata(
    ...
    monkeypatch.setattr(
        "connected_health.google.drive._HTTP_CLIENT.get",
        fake_get,
    )
...
def test_http_drive_client_creates_folder(
    ...
    monkeypatch.setattr(
        "connected_health.google.drive._HTTP_CLIENT.post",
        fake_post,
    )
...
def test_http_drive_client_updates_metadata(
    ...
    monkeypatch.setattr(
        "connected_health.google.drive._HTTP_CLIENT.patch",
        fake_patch,
    )
...
def test_http_drive_client_downloads_file(
    ...
    monkeypatch.setattr(
        "connected_health.google.drive._HTTP_CLIENT.stream",
        fake_stream,
    )
...
def test_http_drive_client_records_download_transfer_and_write_timings(
    ...
    monkeypatch.setattr(
        "connected_health.google.drive.perf_counter",
        lambda: next(clock),
    )
...
def test_http_drive_client_permanently_deletes_file(
    ...
    monkeypatch.setattr(
        "connected_health.google.drive._HTTP_CLIENT.delete",
        fake_delete,
    )
