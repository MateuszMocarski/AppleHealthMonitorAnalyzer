...
from connected_health.application.run_profile_loader import RunProfileLoader
...
@pytest.mark.parametrize(
    "profile_path",
    [
        Path("connected_health/application/examples/run.example.toml"),
        Path("connected_health/application/examples/run.month-summary.toml"),
        Path("connected_health/application/examples/run.partial.toml"),
    ],
)
